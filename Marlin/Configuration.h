...
#define CUSTOM_MACHINE_NAME "A20 1.1.9"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION       { 3000, 3000, 75, 5000 } //1.0.3 { 3000, 3000, 100, 10000 }
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FIL_RUNOUT_INVERTING true //false // set to true to invert the logic of the sensor.
...
#define Z_SAFE_HOMING_X_POINT -16    // X point for Z homing when homing all axes (G28).
#define Z_SAFE_HOMING_Y_POINT -6    // Y point for Z homing when homing all axes (G28).
#endif
...
#define ST7920_DELAY_1 __asm__("nop\n\t");__asm__("nop\n\t")
#define ST7920_DELAY_2 __asm__("nop\n\t");__asm__("nop\n\t")
#define ST7920_DELAY_3 __asm__("nop\n\t");__asm__("nop\n\t")
